...
- Change in provider.conf the database user and the database password to your liking
- Save
- Exit the container
...
Execute this sql in sqlplus. You can copy and paste this, sqlplus can handle newlines in the same statement:
